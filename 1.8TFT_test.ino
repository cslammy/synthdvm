...
void setup(void) {
  ...
  // large block of text
  tft.fillScreen(ST7735_BLACK);
  testdrawtext(1, 45, "Charlie Lamm programs", ST7735_WHITE);
  delay(2000);

  testdrawtext(1, 65, "the 1.8\" screen that", ST7735_WHITE);
  testdrawtext(1, 75, "wasted a sunday", ST7735_WHITE);
  testdrawtext(5, 85, "because of shit", ST7735_WHITE);
  testdrawtext(5, 95, "documentation", ST7735_WHITE);
  delay(6000);
